...
import org.jcodec.codecs.prores.ProResDecoderPerforableInterface;
...
public class JCodecStaticComponent extends AbstractComponentType implements
	...
	public static void main(String[] args) throws IOException {
		new JCodecStaticComponent().run();
	}

	@Start
	public void start() throws Exception {

		ProresDecoder.setStrategy(this);
	...
	org.kevoree.api.service.core.handler.KevoreeModelHandlerService a;
	
	@Perforable(step = 16)
	public int[] scaleMatPerforable(int[] qMatLuma, int qScale) {
